...
namespace Core
{
    internal class UpgradeFile
    {
        ...
        public int ExecuteQuery(string query, Dictionary<string, object> parameters)
        {
            ...
            {
                this.connection.Close(); // Ensure the connection is closed
            }
        }
        ...
        public int ExecuteScalar(string query, Dictionary<string, object> parameters)
        {
            try
            {
                this.Connect(); // Ensure that you have a method to open the database connection
                ...
                using (MySqlCommand cmd = new MySqlCommand(query, this.connection))
                {
                    ...
                    // Execute the query and return the scalar result as an integer
